<template>
  <div class="shade" :class="{show: home.modal.name == 'playlist_add'}">
    <div class="modal" :class="{show: home.modal.name == 'playlist_add'}" @click.stop>
      <div class="header">
      <h4>Nova playlist</h4>
      ...
      <div class="body">
        <div class="forms">
          <div class="field">
          <input ref="title" v-model="form.title" class="form-control" placeholder="Informe o título" maxLength="50" type="text" />
          </div>

          <div class="field"> 
            <label class="isprivate">
            <input v-model="form.isPrivate" class="form-check-input" type="checkbox" value="true"> 
            <span > Setar como playlist privada. </span>
            </label>
          </div>
        </div>

         <div class="buttons">
        <button @click="createPlaylist()" class="sended"> Criar playlist </button>
        </div>
      </div>
      </section>
    </div>
